...
void ConsolUI::tipareste(const VectDinNewDeleteT<Meds> meds) {
	cout << "Medicamentele:\n";
...
void ConsolUI::modificaUI() {
	...
	cout << "Dati pret:";
	cin >> price;
	Element m1 = Meds{ name, producer, actsubst, price };
	...
	cout << "Dati noul pret:";
	cin >> newprice;
	Element m2 = { newname, newproducer, newactsubst, newprice };
	srv.modifyMed(m1, m2);
