...
public:
	Pharmacy(MedRepo& rep, MedValidator& val) :rep{ rep }, val{ val }, RetetaCurenta{ rep } {
	}
	...
	*/
	void deleteMed(string name);

	/*
	modifica un element
	*/
	void updateMed(string name, string newname, string newproducer, string newsubst, int newprice);
