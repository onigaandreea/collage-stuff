...
public class Console {
    ...
    public void removeUserUI() throws InputMismatchException, IllegalArgumentException, ValidationException, SQLException {
        System.out.print("ID User: ");
        int id = in.nextInt();
        service.removeUser(id);
    }

    public void addFriendToUserUI() throws ValidationException, SQLException {
    ...
    public void removeFriendFromUserUI() throws ValidationException, SQLException {
        System.out.print("ID User1: ");
        int id = in.nextInt();
        System.out.print("ID User2: ");
        int id2 = in.nextInt();
