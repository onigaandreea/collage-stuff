...
public class Service {
     ...
     * @throws  IllegalArgumentException if the data read is not the correct format
     */
    public void removeUser(long ID) throws IllegalArgumentException, ValidationException {
     ...
     * @throws   IllegalArgumentException if the data read is not the correct format
     */
    public Friendship searchFriendship(long ID1, long ID2) throws IllegalArgumentException, ValidationException{
    ...
    public void addFriendship(long ID, long ID2) throws IllegalArgumentException, ValidationException {
        ...
        if (user1 != null && user2 != null) {
            if (searchFriendship(ID, ID2) == null) {
                Friendship newFriendship = new Friendship(ID, ID2, LocalDateTime.now().truncatedTo(ChronoUnit.HOURS));
