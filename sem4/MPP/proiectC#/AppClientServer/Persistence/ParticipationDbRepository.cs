...
public class ParticipationDbRepository : IParticipationRepository
{
	...
	private IChildRepository repoC;
	private ITaskRepository repoT;

	public ParticipationDbRepository(IChildRepository childRepository, ITaskRepository taskRepository)
	{
		log.Info("Creating SortingTaskDbRepository ");
		repoC = childRepository;
		repoT = taskRepository;
	}

	public List<Participation> findByTask(Task task1)
	{
